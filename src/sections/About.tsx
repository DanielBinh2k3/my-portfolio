      ...
      <div className="grid h-full grid-cols-1 gap-5 md:grid-cols-2 xl:grid-cols-3 xl:grid-rows-6">
        ...
        <div className="col-span-1 xl:row-span-3">
          <div className="grid-container">
            ...
            <div>
              ...
              <p className="grid-subtext">
                I specialize in Python, LLMs (Qwen, Llama), RAG pipelines,
                vector databases (Qdrant), and full-stack development with
                React.js, FastAPI, and Django.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="col-span-1 xl:row-span-4">
          <div className="grid-container">
            ...
            <div>
              ...
              <p className="grid-subtext">
                I&apos;m based in Hanoi, Vietnam, with remote work available.
              </p>
        ...
        <div className="xl:col-span-2 xl:row-span-3">
          <div className="grid-container">
            ...
            <div>
              <p className="grid-headtext">My Passion for AI & Research</p>
              <p className="grid-subtext">
                I love solving hard problems with AI — from fine-tuning LLMs to
                building multi-agent systems. Research and engineering are both
